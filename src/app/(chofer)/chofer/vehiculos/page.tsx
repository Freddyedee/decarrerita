...
export default async function VehiculosChoferPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 pb-12">
      <ChoferVehiculosClient choferId={session.usuarioId} />
    </main>
  );
}